export default {
  ...
  admin: {
    ...
    proxies: {
      ...
      clashImportTitle: 'Import Clash Subscription',
      clashSubscriptionUrl: 'Subscription URL',
      clashSubscriptionUrlPlaceholder: 'https://example.com/subscription',
      clashFilter: 'Node Filter',
      clashFilterPlaceholder: 'Example: US, Singapore, IEPL. Empty imports all.',
      clashConfigText: 'Clash Config Text',
      clashConfigTextPlaceholder: 'Paste Clash YAML config here',
      clashConfigTextHint: 'Use either subscription URL or config text. Config text takes precedence.',
      clashStartPort: 'Start SOCKS Port',
      clashLimit: 'Import Limit',
      clashRestartSidecars: 'Restart sidecar service after import',
      clashTestAfterImport: 'Test nodes after import',
      clashBenchmarkEnabled: 'Only import high quality nodes',
      clashBenchmarkHint: 'Run a temporary benchmark before import and keep only nodes that can reach OpenAI from allowed regions.',
      clashBenchmarkDuration: 'Benchmark Duration',
      clashBenchmarkDuration1m: '1 minute',
      clashBenchmarkDuration3m: '3 minutes',
      clashBenchmarkDuration5m: '5 minutes',
      clashBenchmarkTopN: 'Keep Top N',
      clashBenchmarkRegions: 'Allowed Regions',
      clashBenchmarkRunning: 'Filtering...',
      clashBenchmarkTopNInvalid: 'Top N must be between 1 and 50',
      clashBenchmarkRegionsRequired: 'Select at least one allowed region',
      clashBenchmarkSummary: 'Benchmarked {duration}s: candidates {requested}, eligible {eligible}, selected {selected}',
      clashBenchmarkRank: 'Rank',
      clashProgressTitle: 'Clash Node Filtering Progress',
      clashProgressStagePrepare: 'Load subscription and start temporary Clash',
      clashProgressStageBenchmark: 'Test OpenAI reachability and latency',
      clashProgressStageSelect: 'Confirm exit region and rank nodes',
      clashProgressStageImport: 'Write proxy nodes',
      clashProgressStageRestart: 'Restart sidecar service',
      clashProgressStageDone: 'Done',
      clashProgressStageError: 'Failed',
      clashProgressElapsed: '{elapsed}s elapsed',
      clashProgressEstimate: 'About {total}s estimated',
      clashProgressPrepareDetail: 'Loading the subscription, generating a temporary config, and waiting for the Clash controller.',
      clashProgressBenchmarkDetail: 'Polling OpenAI through each node. Tested {elapsed}/{total}s.',
      clashProgressSelectDetail: 'Summarizing success rate, latency, and exit region for allowed countries.',
      clashProgressImportDetail: 'Writing sidecar configs and creating or updating proxy records.',
      clashProgressRestartDetail: 'Restarting the sidecar service so selected nodes take effect.',
      clashProgressFinishDetail: 'Waiting for the backend to return the final result.',
      clashProgressDoneDetail: 'Import completed: created {created}, updated {updated}, skipped {skipped}, failed {failed}',
      clashProgressDoneBenchmarkDetail: 'Filtering completed: candidates {requested}, eligible {eligible}, selected {selected}',
      clashProgressFailedDetail: 'The import or filtering process failed. The backend error is shown below.',
      clashImportButton: 'Start Import',
      clashImporting: 'Importing...',
      clashImportNeedSource: 'Enter a subscription URL or paste Clash config',
      clashImportSuccess: 'Import completed: created {created}, updated {updated}, skipped {skipped}, failed {failed}',
      clashImportEmpty: 'No nodes to import',
      clashImportFailed: 'Failed to import Clash subscription',
      clashImportSummary: 'Total {total}, imported {imported}, created {created}, updated {updated}, skipped {skipped}, failed {failed}',
      clashRestarted: 'Sidecar service restarted',
      clashRestartRequired: 'Manual sidecar restart required',
      clashActionCreated: 'Created',
      clashActionUpdated: 'Updated',
      clashActionSkipped: 'Skipped',
      clashActionFailed: 'Failed',
      dataExportSelected: 'Export Selected',
