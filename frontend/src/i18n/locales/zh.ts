export default {
  ...
  admin: {
    ...
    proxies: {
      ...
      testProxy: '测试代理',
      dataImport: '导入',
      clashImport: '导入 Clash 订阅',
      clashImportTitle: '导入 Clash 订阅',
      clashSubscriptionUrl: '订阅链接',
      clashSubscriptionUrlPlaceholder: 'https://example.com/subscription',
      clashFilter: '节点过滤',
      clashFilterPlaceholder: '例如：美国、新加坡、IEPL；留空导入全部',
      clashConfigText: 'Clash 配置文本',
      clashConfigTextPlaceholder: '也可以直接粘贴 Clash YAML 配置',
      clashConfigTextHint: '订阅链接和配置文本二选一；配置文本优先使用。',
      clashStartPort: '起始 SOCKS 端口',
      clashLimit: '最多导入',
      clashRestartSidecars: '导入后重启 sidecar 服务',
      clashTestAfterImport: '导入后逐个测试',
      clashBenchmarkEnabled: '只导入优质节点',
      clashBenchmarkHint: '导入前临时压测订阅节点，只保留能访问 OpenAI 且出口在允许地区内的前 N 个。',
      clashBenchmarkDuration: '压测时长',
      clashBenchmarkDuration1m: '1 分钟',
      clashBenchmarkDuration3m: '3 分钟',
      clashBenchmarkDuration5m: '5 分钟',
      clashBenchmarkTopN: '保留前 N 个',
      clashBenchmarkRegions: '允许地区',
      clashBenchmarkRunning: '筛选中...',
      clashBenchmarkTopNInvalid: '保留数量必须在 1-50 之间',
      clashBenchmarkRegionsRequired: '请至少选择一个允许地区',
      clashBenchmarkSummary: '压测 {duration} 秒：候选 {requested}，合格 {eligible}，已选 {selected}',
      clashBenchmarkRank: '排名',
      clashProgressTitle: 'Clash 节点筛选进度',
      clashProgressStagePrepare: '读取订阅并启动临时 Clash',
      clashProgressStageBenchmark: '逐个测试 OpenAI 连通性和延迟',
      clashProgressStageSelect: '确认出口地区并排序',
      clashProgressStageImport: '写入代理节点',
      clashProgressStageRestart: '重启 sidecar 服务',
      clashProgressStageDone: '完成',
      clashProgressStageError: '失败',
      clashProgressElapsed: '已用 {elapsed} 秒',
      clashProgressEstimate: '预计约 {total} 秒',
      clashProgressPrepareDetail: '正在读取订阅、生成临时配置并等待 Clash 控制端口就绪。',
      clashProgressBenchmarkDetail: '正在按节点轮询 OpenAI，已测试 {elapsed}/{total} 秒。',
      clashProgressSelectDetail: '正在汇总成功率、延迟和出口地区，筛选允许地区内的节点。',
      clashProgressImportDetail: '正在写入 sidecar 配置并创建或更新代理记录。',
      clashProgressRestartDetail: '正在重启 sidecar 服务，让新节点生效。',
      clashProgressFinishDetail: '正在等待后端返回最终结果。',
      clashProgressDoneDetail: '导入完成：新增 {created}，更新 {updated}，跳过 {skipped}，失败 {failed}',
      clashProgressDoneBenchmarkDetail: '筛选完成：候选 {requested}，合格 {eligible}，已选 {selected}',
      clashProgressFailedDetail: '导入或筛选过程失败，下面是后端返回的错误。',
      clashImportButton: '开始导入',
      clashImporting: '导入中...',
      clashImportNeedSource: '请输入订阅链接或粘贴 Clash 配置',
      clashImportSuccess: '导入完成：新增 {created}，更新 {updated}，跳过 {skipped}，失败 {failed}',
      clashImportEmpty: '没有可导入的节点',
      clashImportFailed: 'Clash 订阅导入失败',
      clashImportSummary: '共 {total} 个节点，导入 {imported}，新增 {created}，更新 {updated}，跳过 {skipped}，失败 {failed}',
      clashRestarted: 'sidecar 服务已重启',
      clashRestartRequired: '需要手动重启 sidecar 服务',
      clashActionCreated: '新增',
      clashActionUpdated: '更新',
      clashActionSkipped: '跳过',
      clashActionFailed: '失败',
      dataExportSelected: '导出选中',
